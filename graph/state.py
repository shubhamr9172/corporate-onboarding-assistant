...
class AgentState(TypedDict):
    ...
    source_docs: List[
        Dict[str, Any]
    ]  # List of dicts with {"text": text, "meta": {source, page...}}
    confidence_score: float
    route_decision: str  # 'cache_hit' | 'cache_miss' | 'escalate' | 'progress'
    escalation_summary: Optional[str]
    topics_covered: Dict[
        str, bool
    ]  # {"Policy": bool, "Benefits": bool, "IT Setup": bool, "Team": bool, "Payroll": bool}
    token_usage: Dict[
        str, Any
    ]  # {"input_tokens": int, "output_tokens": int, "total_cost_usd": float}
