...
def run_ingestion():
    ...
    try:
        ...
        collection = chroma_client.get_or_create_collection(
            name="onboarding_faq_collection",
        ...
        if count > 0:
            logger.info(f"Pruning {count} existing records from collection onboarding_faq_collection.")
        ...
        logger.info(f"Ingestion completed. Stored {collection.count()} chunks in ChromaDB.")
